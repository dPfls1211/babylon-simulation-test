...
const MyBabylonComponent: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const createScene = () => {
      // Babylon.js 코드 작성
      const canvas = canvasRef.current; // document.getElementById("renderCanvas1" ) as HTMLCanvasElement;
      if (!canvas) return;
      ...
      //https://dt.gractor.com/glb/space3_1.glb
      ...
      // @ts-ignore
                robotPanel,
                new BABYLON.Color3(1, 0.54, 0.74)
              );
  ...
  return (
    ...
    <canvas
      id="renderCanvas1"  ref={canvasRef} 
